...
<html>
  <head>
    ...
    <meta charset="UTF-8">
    <title>Farizan's Blog</title>
    <link rel="icon" type="image/svg+xml" href="{{asset('img/urku-ico.svg')}}">
    <link rel="stylesheet" href="{{asset('css/aurora-pack.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/aurora-theme-base.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/urku.css')}}">
  </head>
  <body class="top-fixed">
    <header class="ae-container-fluid ae-container-fluid--full rk-header ">
      ...
      <label for="mobile-menu">
        <svg>
          <use xlink:href="{{asset('img/symbols.svg#bar')}}"></use>
        </svg>
        <svg>
          <use xlink:href="{{asset('img/symbols.svg#bar')}}"></use>
        </svg>
      ...
      <div class="ae-container-fluid rk-topbar">
        <h1 class="rk-logo"><a href="index.html">Farizan Ramadhan</a></h1>
        <nav class="rk-navigation">
          ...
          <form class="rk-search">
            ...
            <label for="urku-search">
              <svg>
                <use xlink:href="{{asset('img/symbols.svg#icon-search')}}"></use>
              </svg>
            </label>
          </form>
        </nav>
    ...
    <section class="ae-container-fluid rk-main">
      ...
      <div class="ae-container-fluid rk-layout-ctrl-cont">
        <label for="layout-base" class="rk-layout-ctrl">
          <svg>
            <use xlink:href="{{asset('img/symbols.svg#icon-view-default')}}"></use>
          </svg>
        </label>
      </div>
      ...
      <div class="ae-container-fluid rk-layout-ctrl-cont">
        <label for="layout-grid" class="rk-layout-ctrl">
          <svg>
            <use xlink:href="{{asset('img/symbols.svg#icon-view-alt')}}"></use>
          </svg>
        </label>
      </div>
    ...
    <footer class="ae-container-fluid rk-footer ">
      <div class="ae-grid ae-grid--collapse">
        <div class="ae-grid__item item-lg-4 au-xs-ta-center au-lg-ta-left">
          ...
          <!-- <p class="rk-footer__text rk-footer__copy "> <span class="ae-u-bold">© </span><span class="ae-u-bolder">2018 URKU PORTFOLIO </span>All Right Reserved.</p> -->
        </div>
        <div class="ae-grid__item item-lg-4 au-xs-ta-center"><a href="#0" class="rk-social-btn ">
            <svg>
              <use xlink:href="{{asset('img/symbols.svg#icon-facebook')}}"></use>
            </svg></a><a href="#0" class="rk-social-btn ">
            <svg>
              <use xlink:href="{{asset('img/symbols.svg#icon-twitter')}}"></use>
            </svg></a><a href="#0" class="rk-social-btn ">
            <svg>
              <use xlink:href="{{asset('img/symbols.svg#icon-pinterest')}}"></use>
            </svg></a><a href="#0" class="rk-social-btn ">
            <svg>
              <use xlink:href="{{asset('img/symbols.svg#icon-tumblr')}}"></use>
            </svg></a></div>
